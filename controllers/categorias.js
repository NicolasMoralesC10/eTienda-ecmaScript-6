...
import Categoria from './models/Categoria.js'; // Asegúrate de usar la extensión
...
export const buscarxid = async (req, res) => {
...
export const actualizarxid = async (req, res) => {
...
export const borrarxid = async (req, res) => {
